...
class ProfilDatabase {
  ...
  updateProfilLocation(userId, locationDict) async {
    var url =
        Uri.parse(databaseUrl + "database/profils/updateProfilLocation.php");
...
class CommunityDatabase {
  ...
  updateLocation(id, locationData) async {
    var url =
        Uri.parse(databaseUrl + "database/communities/changeLocation.php");
...
class StadtinfoUserDatabase {
  addNewInformation(stadtinformation) async {
    var userId = FirebaseAuth.instance.currentUser.uid;
    var url =
        Uri.parse(databaseUrl + "database/stadtinfoUser/newInformation.php");
...
uploadImage(imagePath, imageName, image) async {
  var url =
      Uri.parse("https://families-worldwide.com/database/uploadImage.php");
  var data = {
    "imagePath": imagePath,
    "imageName": imageName,
...
DbDeleteImage(imageName) async {
  var url =
      Uri.parse("https://families-worldwide.com/database/deleteImage.php");
