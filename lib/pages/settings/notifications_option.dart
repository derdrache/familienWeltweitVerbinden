    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(AppLocalizations.of(context)!.chatNotificationHinweis)
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(AppLocalizations.of(context)!.meetupNotificationHinweis)
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(AppLocalizations.of(context)!.newFriendNotificationHinweis)
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(AppLocalizations.of(context)!.familieAroundNotificationHinweis)
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(AppLocalizations.of(context)!.travelPlanNotificationHinweis)
        ],
      ),
    );
  }
